...
global_client_keys:def_key({ modkey, "Shift"  }, "b", function (c)
    scratch.drop("pavucontrol", "center", "center", 0.5, 0.5, true)
end)
global_keys:def_key({ modkey, "Shift" }, "q", function () util.lock_screen() end)
global_keys:def_key({ modkey }, "Return", function ()
    exec(config.terminal)
end)
global_keys:def_key({ modkey, "Shift" }, "a", function ()
    sexec("qsnip -s")
end)
...
global_keys:def_key({ modkey, "Shift" }, "z", function ()
