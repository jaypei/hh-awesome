...
local conf_dir  = os.getenv("HOME") .. "/.config/awesome/"
...
notify.critical = function (title, text)
  local scount = screen.count()
  for i = 1, scount do
...
naughty.config.defaults.font = "SourceCode Pro 15px"
naughty.config.defaults.bg = "#003300"
naughty.config.defaults.fg = "#FFFFFF"
naughty.config.defaults.border_color = "#33ff00"
...
-- beautiful init
beautiful.init(conf_dir .. "themes/" .. theme .. "/theme.lua")
